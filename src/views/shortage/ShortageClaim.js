...
import { Grid, Typography, Box, styled, Button, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} lg={6}>
                            <DashboardCard
                                title={<Typography variant='h4'>Current Progress</Typography>}
                                action={
                                    <ButtonStyled onClick={handlePayeeCodeButtonClick}>Payee Code</ButtonStyled>
                                }>
