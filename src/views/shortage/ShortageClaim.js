								...
								<Grid item xs>
									<DashboardCard>
										<Grid container spacing={3} alignItems="center">
											...
											<Grid item sm={4}>
												<Typography variant='h4' style={{ color: theme.palette.primary.main }}>18 h</Typography>
											</Grid>
										</Grid>
									</DashboardCard>
								</Grid>
								...
								<Grid item xs>
									<DashboardCard>
										<Grid container spacing={3} alignItems="center">
											...
											<Grid item sm={4}>
												<Typography variant='h4' style={{ color: theme.palette.success.main }}>$58954</Typography>
											</Grid>
										</Grid>
									</DashboardCard>
								</Grid>
